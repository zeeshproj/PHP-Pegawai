    ...
    <div class="container">
      <div class="forms-container">
        <div class="signin-signup">
          <form action="process_login.php" class="sign-in-form" method = "post">
        ...
        ?>
          ...
          <a href="https://google.com" class="social-icon" target="_blank">
            ...
            <a href="https://id.linkedin.com" class="social-icon" target="_blank">
          <i class="fab fa-linkedin-in"></i>
            </a>
            </div>

          </form>
          <form action="process_register.php" class="sign-up-form" method="POST">
